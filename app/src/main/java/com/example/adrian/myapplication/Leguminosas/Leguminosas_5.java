...
public class Leguminosas_5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.leguminosas_nivel_5);
                    ...
                    builder.setMessage("Pasaste al siguiente nivel")
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    helper.insertLegu(l);
                                    Intent intent1 = new Intent(Leguminosas_5.this,Leguminosas_6.class);
                                    startActivity(intent1); //*corregido
                                    //  startActivity(intent2);
                                    Toast.makeText(Leguminosas_5.this, "Nivel 6", Toast.LENGTH_LONG).show();
                                }
                            });
