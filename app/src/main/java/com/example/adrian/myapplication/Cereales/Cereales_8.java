...
public class Cereales_8 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cereales_nivel_8);
                ...
                builder.setMessage("Pasaste al siguiente nivel")
                        ...
                        .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent intent1 = new Intent(Cereales_8.this,Cereales_9.class);
                                startActivity(intent1); //*corregido
                                //  startActivity(intent2);
                                Toast.makeText(Cereales_8.this, "Nivel 9", Toast.LENGTH_LONG).show();
                            }
                        });
