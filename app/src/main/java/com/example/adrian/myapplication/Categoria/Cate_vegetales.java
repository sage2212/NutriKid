...
import com.example.adrian.myapplication.Vegetales.Vegetales_1;
import com.example.adrian.myapplication.Vegetales.Vegetales_2;
import com.example.adrian.myapplication.Vegetales.Vegetales_3;
import com.example.adrian.myapplication.Vegetales.Vegetales_4;
import com.example.adrian.myapplication.Vegetales.Vegetales_5;
import com.example.adrian.myapplication.Vegetales.Vegetales_6;
import com.example.adrian.myapplication.Vegetales.Vegetales_7;
import com.example.adrian.myapplication.Vegetales.Vegetales_8;
import com.example.adrian.myapplication.Vegetales.Vegetales_9;

public class Cate_vegetales extends Activity {
    DatabaseHelper helper = new DatabaseHelper(this);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.categoria_vegetales);
        ...
        btn_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Vegetales_1.class);
        ...
        btn_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(),Vegetales_2.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Vegetales_3.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Vegetales_4.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Vegetales_5.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Vegetales_6.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Vegetales_7.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Vegetales_8.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Vegetales_9.class);
                startActivityForResult(intent, 0);
            }
        });
