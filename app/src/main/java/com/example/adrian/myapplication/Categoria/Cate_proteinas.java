...
import com.example.adrian.myapplication.Proteinas.Proteinas_1;
import com.example.adrian.myapplication.Proteinas.Proteinas_2;
import com.example.adrian.myapplication.Proteinas.Proteinas_3;
import com.example.adrian.myapplication.Proteinas.Proteinas_4;
import com.example.adrian.myapplication.Proteinas.Proteinas_5;
import com.example.adrian.myapplication.Proteinas.Proteinas_6;
import com.example.adrian.myapplication.Proteinas.Proteinas_7;
import com.example.adrian.myapplication.Proteinas.Proteinas_8;
import com.example.adrian.myapplication.Proteinas.Proteinas_9;
import com.example.adrian.myapplication.R;

public class Cate_proteinas extends Activity {
    DatabaseHelper helper = new DatabaseHelper(this);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.categoria_proteinas);
        ...
        btn_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Proteinas_1.class);
        ...
        btn_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Proteinas_2.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Proteinas_3.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Proteinas_4.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Proteinas_5.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Proteinas_6.class);
                startActivityForResult(intent, 0);
            }
        });
