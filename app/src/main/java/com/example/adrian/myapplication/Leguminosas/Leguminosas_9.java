...
public class Leguminosas_9 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.leguminosas_nivel_9);
    ...
    public void Enviar(View v){
        if(Nombre.getText().toString().isEmpty()){
            ...
            if(Nombre.getText().toString().equals("platano")||(Nombre.getText().toString().equals("PLATANO"))||(Nombre.getText().toString().equals("Platano"))){
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
                builder.setMessage("Pasaste a la siguiente categoria Cereales")
                        .setTitle("Felicidades")
                        .setCancelable(false)
                        .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {

                                Intent intent1 = new Intent(Leguminosas_9.this,Cereales_1.class);
                                startActivity(intent1); //*corregido
                                //  startActivity(intent2);
                                Toast.makeText(Leguminosas_9.this, "Feliciades Pasaste a la cateogria Cereales", Toast.LENGTH_LONG).show();
                            }
                        });
