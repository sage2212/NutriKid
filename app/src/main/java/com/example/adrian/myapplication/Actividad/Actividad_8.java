...
public class Actividad_8 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actividad_nivel_8);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case RECOGNIZE_SPEECH_ACTIVITY:
                ...
                if(Nombre.getText().toString().equals("tenis")||(Nombre.getText().toString().equals("TENIS"))||(Nombre.getText().toString().equals("Tenis"))){
                    AlertDialog.Builder builder = new AlertDialog.Builder(this);
                    builder.setMessage("Pasaste al siguiente nivel")
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent1 = new Intent(Actividad_8.this,Actividad_9.class);
                                    startActivity(intent1); //*corregido
                                    //  startActivity(intent2);
                                    Toast.makeText(Actividad_8.this, "Nivel 9", Toast.LENGTH_LONG).show();
                                }
                            });
