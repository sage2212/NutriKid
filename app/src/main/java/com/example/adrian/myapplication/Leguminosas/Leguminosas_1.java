...
public class Leguminosas_1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.leguminosas_nivel_1);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case RECOGNIZE_SPEECH_ACTIVITY:
                ...
                if(Nombre.getText().toString().equals("frijol")||(Nombre.getText().toString().equals("FRIJOL"))||(Nombre.getText().toString().equals("Frijol"))){
                    AlertDialog.Builder builder = new AlertDialog.Builder(this);
                    builder.setMessage("Pasaste al siguiente nivel")
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    helper.insertLegu(l);
                                    Intent intent1 = new Intent(Leguminosas_1.this,Leguminosas_2.class);
                                    startActivity(intent1); //*corregido
                                    //  startActivity(intent2);
                                    Toast.makeText(Leguminosas_1.this, "Nivel 2", Toast.LENGTH_LONG).show();
                                }
                            });
