...
public class Leguminosas_4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.leguminosas_nivel_4);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case RECOGNIZE_SPEECH_ACTIVITY:
                ...
                if(Nombre.getText().toString().equals("garbanzo")||(Nombre.getText().toString().equals("GARBANZO"))||(Nombre.getText().toString().equals("Garbanzo"))){
                    AlertDialog.Builder builder = new AlertDialog.Builder(this);
                    builder.setMessage("Pasaste al siguiente nivel")
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    helper.insertLegu(l);
                                    Intent intent1 = new Intent(Leguminosas_4.this,Leguminosas_5.class);
                                    startActivity(intent1); //*corregido
                                    //  startActivity(intent2);
                                    Toast.makeText(Leguminosas_4.this, "Nivel 5", Toast.LENGTH_LONG).show();
                                }
                            });
