...
public class Cereales_7 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cereales_nivel_7);
                ...
                builder.setMessage("Pasaste al siguiente nivel")
                        ...
                        .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent intent1 = new Intent(Cereales_7.this,Cereales_8.class);
                                startActivity(intent1); //*corregido
                                //  startActivity(intent2);
                                Toast.makeText(Cereales_7.this, "Nivel 8", Toast.LENGTH_LONG).show();
                            }
                        });
