...
import com.example.adrian.myapplication.Actividad.Actividad_3;
import com.example.adrian.myapplication.Actividad.Actividad_4;
import com.example.adrian.myapplication.Actividad.Actividad_5;
import com.example.adrian.myapplication.Actividad.Actividad_6;
import com.example.adrian.myapplication.Actividad.Actividad_7;
import com.example.adrian.myapplication.Actividad.Actividad_8;
import com.example.adrian.myapplication.Actividad.Actividad_9;
...
public class Cate_actividad extends Activity {
    DatabaseHelper helper = new DatabaseHelper(this);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.categoria_actividad);
        ...
        btn_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Actividad_1.class);
        ...
        btn_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Actividad_2.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Actividad_3.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Actividad_4.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Actividad_5.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Actividad_6.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Actividad_7.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Actividad_8.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Actividad_9.class);
                startActivityForResult(intent, 0);
            }
        });
