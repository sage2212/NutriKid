...
public class Cereales_1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cereales_nivel_1);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case RECOGNIZE_SPEECH_ACTIVITY:
                ...
                if(Nombre.getText().toString().equals("maíz")||(Nombre.getText().toString().equals("MAÍZ"))||(Nombre.getText().toString().equals("Maz"))){
                    AlertDialog.Builder builder = new AlertDialog.Builder(this);
                    builder.setMessage("Pasaste al siguiente nivel")
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    DataCategoria c = new DataCategoria();
                                    c.setNivel("2");
                                    c.setValor("1");

                                    helper.insertCereales(c);

                                    Intent intent1 = new Intent(Cereales_1.this,Cereales_2.class);
                                    startActivity(intent1); //*corregido
                                    //  startActivity(intent2);
                                    Toast.makeText(Cereales_1.this, "Nivel 2", Toast.LENGTH_LONG).show();
                                }
                            });
    ...
    public void Enviar(View v){
        if(Nombre.getText().toString().isEmpty()){
            ...
            if(Nombre.getText().toString().equals("maiz")||(Nombre.getText().toString().equals("MAIZ"))||(Nombre.getText().toString().equals("Maiz"))){
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
                builder.setMessage("Pasaste al siguiente nivel")
                        .setTitle("Felicidades")
                        .setIcon(R.drawable.sonrisa)
    ...
    public void PopUp(View v) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage("Empieza con la letra M")
                .setTitle("Ayuda")
