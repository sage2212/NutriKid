...
public class Vegetales_8 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vegetales_nivel_8);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case RECOGNIZE_SPEECH_ACTIVITY:
                ...
                if(Nombre.getText().toString().equals("betabel")||(Nombre.getText().toString().equals("BETABEL"))||(Nombre.getText().toString().equals("Betabel"))){
                    AlertDialog.Builder builder = new AlertDialog.Builder(this);
                    builder.setMessage("Pasaste al siguiente nivel")
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent1 = new Intent(Vegetales_8.this,Vegetales_9.class);
                                    startActivity(intent1); //*corregido
                                    //  startActivity(intent2);
                                    Toast.makeText(Vegetales_8.this, "Nivel 9", Toast.LENGTH_LONG).show();
                                }
                            });
