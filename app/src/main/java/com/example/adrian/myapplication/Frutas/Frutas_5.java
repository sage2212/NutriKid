...
public class Frutas_5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frutas_nivel_5);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case RECOGNIZE_SPEECH_ACTIVITY:
                ...
                if(Nombre.getText().toString().equals("manzana")||(Nombre.getText().toString().equals("MANZANA"))||(Nombre.getText().toString().equals("Manzana"))){
                    AlertDialog.Builder builder = new AlertDialog.Builder(this);
                    builder.setMessage("Pasaste al siguiente nivel")
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    DataCategoria f = new DataCategoria();
                                    f.setNivel("6");
                                    f.setValor("1");

                                    helper.insertFruta(f);

                                    Intent intent1 = new Intent(Frutas_5.this,Frutas_6.class);
                                    startActivity(intent1); //*corregido
                                    //  startActivity(intent2);
                                    Toast.makeText(Frutas_5.this, "Nivel 6", Toast.LENGTH_LONG).show();
                                }
                            });
