...
public class Actividad_3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actividad_nivel_3);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case RECOGNIZE_SPEECH_ACTIVITY:
                ...
                if(Nombre.getText().toString().equals("natación")||(Nombre.getText().toString().equals("NATACIÓN"))||(Nombre.getText().toString().equals("Natación"))){
                    AlertDialog.Builder builder = new AlertDialog.Builder(this);
                    builder.setMessage("Pasaste al siguiente nivel")
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent1 = new Intent(Actividad_3.this,Actividad_4.class);
                                    startActivity(intent1); //*corregido
                                    //  startActivity(intent2);
                                    Toast.makeText(Actividad_3.this, "Nivel 4", Toast.LENGTH_LONG).show();
                                }
                            });
