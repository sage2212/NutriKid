...
public class Leguminosas_8 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.leguminosas_nivel_8);
                ...
                builder.setMessage("Pasaste al siguiente nivel")
                        ...
                        .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                helper.insertLegu(l);
                                Intent intent1 = new Intent(Leguminosas_8.this,Leguminosas_9.class);
                                startActivity(intent1); //*corregido
                                //  startActivity(intent2);
                                Toast.makeText(Leguminosas_8.this, "Nivel 9", Toast.LENGTH_LONG).show();
                            }
                        });
