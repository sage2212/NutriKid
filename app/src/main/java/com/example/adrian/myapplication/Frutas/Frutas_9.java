package com.example.adrian.myapplication.Frutas;
...
public class Frutas_9 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frutas_nivel_9);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case RECOGNIZE_SPEECH_ACTIVITY:
                ...
                if(Nombre.getText().toString().equals("guayaba")||(Nombre.getText().toString().equals("GUAYABA"))||(Nombre.getText().toString().equals("Guayaba"))){
                    AlertDialog.Builder builder = new AlertDialog.Builder(this);
                    builder.setMessage("Pasaste a la siguiente categoria Verduras")
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent1 = new Intent(Frutas_9.this,Vegetales_1.class);
                                    startActivity(intent1); //*corregido
                                    //  startActivity(intent2);
                                    Toast.makeText(Frutas_9.this, "Feliciades Pasaste a la cateogria Verduras", Toast.LENGTH_LONG).show();
                                }
                            });
