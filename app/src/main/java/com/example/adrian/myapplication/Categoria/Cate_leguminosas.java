...
import com.example.adrian.myapplication.Leguminosas.Leguminosas_2;
import com.example.adrian.myapplication.Leguminosas.Leguminosas_3;
import com.example.adrian.myapplication.Leguminosas.Leguminosas_4;
import com.example.adrian.myapplication.Leguminosas.Leguminosas_5;
import com.example.adrian.myapplication.Leguminosas.Leguminosas_6;
import com.example.adrian.myapplication.Leguminosas.Leguminosas_7;
import com.example.adrian.myapplication.Leguminosas.Leguminosas_8;
import com.example.adrian.myapplication.Leguminosas.Leguminosas_9;
import com.example.adrian.myapplication.R;

public class Cate_leguminosas extends Activity {
    DatabaseHelper helper = new DatabaseHelper(this);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.categoria_leguminosas);
        ...
        btn_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Leguminosas_1.class);
        ...
        btn_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Leguminosas_2.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(),  Leguminosas_3.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(),  Leguminosas_4.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(),  Leguminosas_5.class);
                startActivityForResult(intent, 0);
            }
        });
        ...
        btn_6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(),  Leguminosas_6.class);
                startActivityForResult(intent, 0);
            }
        });
