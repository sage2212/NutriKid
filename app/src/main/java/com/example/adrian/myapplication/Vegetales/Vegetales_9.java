...
public class Vegetales_9 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vegetales_nivel_9);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case RECOGNIZE_SPEECH_ACTIVITY:
                ...
                if(Nombre.getText().toString().equals("pepino")||(Nombre.getText().toString().equals("PEPINO"))||(Nombre.getText().toString().equals("Pepino"))){
                    AlertDialog.Builder builder = new AlertDialog.Builder(this);
                    builder.setMessage("Pasaste a la siguiente categoria")
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent1 = new Intent(Vegetales_9.this,Proteinas_1.class);
                                    startActivity(intent1); //*corregido
                                    //  startActivity(intent2);
                                    Toast.makeText(Vegetales_9.this, "Feliciades Pasaste a la cateogria Proteinas ", Toast.LENGTH_LONG).show();
                                }
                            });
